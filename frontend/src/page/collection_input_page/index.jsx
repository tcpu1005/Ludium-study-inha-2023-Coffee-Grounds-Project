...
import {
  StyledContainer, StyledInputContainer, StyledLabel, StyledInput, StyledSelect, StyledButton,
  Coffee_Status, Coffee_Statuscon, Coffee_weight, Coffee_weightcon, Coffee_date, Coffee_monthcon, Cha_month, KG
} from "./style";
