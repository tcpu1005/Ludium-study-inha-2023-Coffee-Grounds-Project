...
const Collection_page = () => {
    ...
    useEffect(() => {
        ...
        const new_collection_list = Array.from({ length: 131 }, (v, i) => {
            return { record_id: `UUID_CAFFEINE_ADDICTION_${i}`, reward_process: "수거 요청", updated_at: new Date(), coffee_amount: 100, coffee_status: "곰팡이" };
        })
    ...
    return (
        <>
            ...
            <List_component current_list={collection_list.slice((current_page_number - 1) * page_unit, current_page_number * page_unit)} set_collection_choice={set_collection_choice} />
            ...
            <div>
                ...
                {total_page_count && Array.from({ length: page_number_unit }, (v, i) => i).map((v, i) => {
                    //
            ...
            <Button_3 onClick={() => nav("/collection/input", { state: { collection_choice_data: collection_list.find((v, i) => v.record_id === collection_choice) } })}>수거하기</Button_3>
        </>
    );
};
