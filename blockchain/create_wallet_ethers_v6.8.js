...
// JsonRpcProvider failed to detect network and cannot start up; retry in 1s (perhaps the URL is wrong or the node is not sta
module.exports.get_polygon_provider_fn = () => new ethers.JsonRpcProvider("https://rpc-mumbai.matic.today", "matic");


// Error: error response (request={  }, response={  }, info={ "result": { "error": { "code": -32000, "message": "invalid opcode: PUSH0" }, "id": 1, "jsonrpc": "2.0" } }, code=SERVER_ERROR, version=6.8.0)
module.exports.get_etherscan_provider_fn = () => new ethers.EtherscanProvider("maticmum");


// Error: missing revert data (action="estimateGas", data=null, reason=null, transaction={ "data": 
// info: {
//     error: { code: -32000, message: 'invalid opcode: PUSH0' },
//     payload: {
//       method: 'eth_estimateGas',
module.exports.get_ankr_provider_fn = () => new ethers.JsonRpcProvider("https://rpc.ankr.com/polygon_mumbai", "maticmum");
